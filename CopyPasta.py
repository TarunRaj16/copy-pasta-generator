...
def generate_copy_pasta(json_string):
    ...
    result = parser.replace_indices([12, 13, 25, 28, 29, 37, 38, 39, 41, 49, 54, 61, 65, 66, 67, 76, 85, 97, 110, 112, 117, 122, 130, 133, 139, 142, 151, 153, 155, 160, 161, 166, 170, 172, 183, 197, 198, 206, 207, 216, 221, 222, 235, 236, 242, 245, 246, 254, 255, 259, 261], navy_seals_pasta)
    print(result)
    return result
